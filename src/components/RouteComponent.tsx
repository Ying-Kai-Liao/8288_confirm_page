  ...
  return (
    <div className="flex items-center justify-center flex-col">
      <div className="flex items-center justify-center flex-col" id="card">
        ...
        <div className="flex flex-col text-center rounded-[20px] bg-white max-w-[500px] mx-5 md:w-[500px] shadow-lg">
          ...
          <div className="px-10 pb-10 divide-y divide-dashed">
            ...
            <div className="py-5 flex flex-col">
              ...
              <div className="flex justify-between">
                ...
                <div className="font-semibold">
                  <PaymentDetails
                    paymentType={orderInfo?.PaymentType}
                    Info={responseData?.CVSInfo}
                  />
                  {orderInfo?.PaymentType === "Credit" &&
                    `${responseData?.CardInfo.Card6No}******${responseData?.CardInfo.Card4No}`}
                  <ATMPaymentDetails
                    paymentType={orderInfo?.PaymentType}
                    Info={responseData?.ATMInfo}
                    AccountNo
            ...
            <div className="py-5">
              <div
                className={`flex justify-between py-2 text-xl ${
                  success ? "text-green-500" : "text-red-500"
                }`}
              >
                <div className=" text-left">總金額</div>
              ...
              >
                <div className=" text-left">訂單狀態</div>
                <div className="text-right font-bold">
                  {success ? "付款成功" : "付款失敗"}
                </div>
              </div>
      ...
      <div className="flex flex-row justify-center md:w-[400px] max-w-[400px]">
        <div
          className="justify-center text-white hover:text-purple-800
